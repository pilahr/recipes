  ...
  return (
    <div className="create-form-container">
      ...
      <form className="create-form-container__form" >
        <label className="create-form-container__form--label">Recipe Name</label>
        <input
          className="create-form-container__form--input"
          placeholder="Name of the recipe"
        />
        <label className="create-form-container__form--label">Ingredients</label>
        <input
          className="create-form-container__form--input"
        ...
        />
        <label className="create-form-container__form--label">Nationality</label>
        <input
          className="create-form-container__form--input"
        ...
        <Button
          buttonText="Submit"
          func="create"
          className="create-form-container__form--button"
        />
      </form>
    </div>
  );
